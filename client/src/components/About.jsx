...
const About =()=> {
    return (
        ...
        <Container style={{marginTop: "50px"}}>
            <h1>Where we are</h1>
            <p>Lorem ipsum dolor sit jay, consectetur adipisicing elit. Consequuntur delectus dolorem quaerat est molestias, debitis eius officiis? Error alias nostrum repellat earum esse aliquam molestias, culpa possimus ratione laudantium blanditiis!</p>
